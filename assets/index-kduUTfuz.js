...
`,po=`
####
Opening Hours:  <br/><b>Monday - Friday: 7:45 AM - 8:00 PM</b>`,mo=`At **Dia’s Delicacy**, we pride ourselves on creating unforgettable experiences for life’s special moments. Whether you’re planning an intimate gathering or a grand celebration, our party and catering services are designed to suit your needs. Host your event at our venue or let us bring the flavors to you.
...
Have any other special requests? Let’s discuss them with you to make your event truly unforgettable.   `,ho=`Dia's Delicacy est née du rêve sincère d’une femme de faire revivre les saveurs précieuses de son enfance. Aujourd’hui, cette vision s’est épanouie en une véritable destination culinaire — un hommage à la richesse et à la diversité du patrimoine gastronomique indien.
...
Chaque ingrédient est soigneusement sélectionné, et chaque plat est préparé avec précision et amour, afin d’offrir à chaque convive une expérience gastronomique mémorable.`,go=`<!-- show: false -->
### Avis de Fermeture
...
`,_o=`📍 Adresse: **Rue Schaub 11, 1202 Genève**
...
Une autre demande particulière ? Parlons-en ensemble pour rendre votre événement vraiment inoubliable.   `,bo=`<!-- tab: Nos Matériaux -->
<!--show: false-->
...
* ### **Curry de palak frais du domaine :**
  ...
  Épinards frais du jardin cuisinés aux cacahuètes et au dal de pois chiches (Gram dal), accompagnés d'un savoureux pulao aux petits pois et d'une salade.`,Eo=`
# 12 Mai, Mardi
...
* ### **Malai Kofta / Curry de Tofu :** 🌱
    Boulettes de légumes et fromage frais dans une sauce douce et crémeuse, ou tofu mijoté dans un curry parfumé aux épices.`,jo=`## 21 Mai, Jeudi
...
* ### **Dosa Aloo & Dosa Légumes Mixtes :** 🌱
    Crêpes croustillantes du sud de l’Inde garnies de pommes de terre épicées ou de légumes variés, servies avec du sambhar (ragoût de lentilles et légumes) et un chutney de noix de coco.`,No=`## 25 Mai, Lundi
...
* ### **Poulet Mughlai :** 🍗 <span class="prix">22 CHF🍽️ / 20 CHF🥡</span>
    Poulet préparé dans une sauce royale riche et crémeuse aux noix, servie avec du riz et des légumes de saison. / *Chicken cooked in a rich, creamy, and nutty royal Mughlai gravy, served with rice and seasonal vegetables.*`,Zo=`### 18 Juin, Jeudi 
...
`,js=`
####
Horaires d'ouverture: <br/><b>Lundi - Vendredi: 07h45 - 20h00</b>`;function Ms(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Ns=Ms();function Ps(e){Ns=e}var Fs={exec:()=>null};function Z(e,t=``){let n=typeof e==`string`?e:e.source,r={replace:(e,t)=>{let i=typeof t==`string`?t:t.source;return i=i.replace(Q.caret,`$1`),n=n.replace(e,i),r},getRegex:()=>new RegExp(n,t)};return r}var Is=((e=``)=>{try{return!!RegExp(`(?<=1)(?<!1)`+e)}catch{return!1}})(),Q={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}#`),htmlBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}<(?:[a-z].*>|!--)`,`i`),blockquoteBeginRegex:e=>RegExp(`^ {0,${Math.min(3,e-1)}}>`)},Ls=/^(?:[ \t]*(?:\n|$))+/,Rs=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,zs=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Bs=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Vs=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Hs=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,Us=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Ws=Z(Us).replace(/bull/g,Hs).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,``).getRegex(),Gs=Z(Us).replace(/bull/g,Hs).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Ks=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,qs=/^[^\n]+/,Js=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Ys=Z(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace(`label`,Js).replace(`title`,/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Xs=Z(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Hs).getRegex(),Zs=`address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,Qs=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,$s=Z(`^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))`,`i`).replace(`comment`,Qs).replace(`tag`,Zs).replace(`attribute`,/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),ec=Z(Ks).replace(`hr`,Bs).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)])[ \\t]`).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,Zs).getRegex(),tc={blockquote:Z(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace(`paragraph`,ec).getRegex(),code:Rs,def:Ys,fences:zs,heading:Vs,hr:Bs,html:$s,lheading:Ws,list:Xs,newline:Ls,paragraph:ec,table:Fs,text:qs},nc=Z(`^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)`).replace(`hr`,Bs).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`blockquote`,` {0,3}>`).replace(`code`,`(?: {4}| {0,3}	)[^\\n]`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)])[ \\t]`).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,Zs).getRegex(),rc={...tc,lheading:Gs,table:nc,paragraph:Z(Ks).replace(`hr`,Bs).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`table`,nc).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)])[ \\t]`).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,Zs).getRegex()},ic={...tc,html:Z(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace(`comment`,Qs).replace(/tag/g,`(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b`).getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Fs,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:Z(Ks).replace(`hr`,Bs).replace(`heading`,` *#{1,6} *[^
]`).replace(`lheading`,Ws).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`|fences`,``).replace(`|list`,``).replace(`|html`,``).replace(`|tag`,``).getRegex()},ac=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,oc=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,sc=/^( {2,}|\\)\n(?!\s*$)/,cc=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,lc=/[\p{P}\p{S}]/u,uc=/[\s\p{P}\p{S}]/u,dc=/[^\s\p{P}\p{S}]/u,fc=Z(/^((?![*_])punctSpace)/,`u`).replace(/punctSpace/g,uc).getRegex(),pc=/(?!~)[\p{P}\p{S}]/u,mc=/(?!~)[\s\p{P}\p{S}]/u,hc=/(?:[^\s\p{P}\p{S}]|~)/u,gc=Z(/link|precode-code|html/,`g`).replace(`link`,/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace(`precode-`,Is?"(?<!`)()":"(^^|[^`])").replace(`code`,/(?<b>`+)[^`]+\k<b>(?!`)/).replace(`html`,/<(?! )[^<>]*?>/).getRegex(),_c=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,vc=Z(_c,`u`).replace(/punct/g,lc).getRegex(),yc=Z(_c,`u`).replace(/punct/g,pc).getRegex(),bc=`^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,xc=Z(bc,`gu`).replace(/notPunctSpace/g,dc).replace(/punctSpace/g,uc).replace(/punct/g,lc).getRegex(),Sc=Z(bc,`gu`).replace(/notPunctSpace/g,hc).replace(/punctSpace/g,mc).replace(/punct/g,pc).getRegex(),Cc=Z(`^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)`,`gu`).replace(/notPunctSpace/g,dc).replace(/punctSpace/g,uc).replace(/punct/g,lc).getRegex(),wc=Z(/^~~?(?:((?!~)punct)|[^\s~])/,`u`).replace(/punct/g,lc).getRegex(),Tc=Z(`^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)`,`gu`).replace(/notPunctSpace/g,dc).replace(/punctSpace/g,uc).replace(/punct/g,lc).getRegex(),Ec=Z(/\\(punct)/,`gu`).replace(/punct/g,lc).getRegex(),Dc=Z(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace(`scheme`,/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace(`email`,/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Oc=Z(Qs).replace(`(?:-->|$)`,`-->`).getRegex(),kc=Z(`^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>`).replace(`comment`,Oc).replace(`attribute`,/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Ac=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,jc=Z(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace(`label`,Ac).replace(`href`,/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace(`title`,/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Mc=Z(/^!?\[(label)\]\[(ref)\]/).replace(`label`,Ac).replace(`ref`,Js).getRegex(),Nc=Z(/^!?\[(ref)\](?:\[\])?/).replace(`ref`,Js).getRegex(),Pc=Z(`reflink|nolink(?!\\()`,`g`).replace(`reflink`,Mc).replace(`nolink`,Nc).getRegex(),Fc=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Ic={_backpedal:Fs,anyPunctuation:Ec,autolink:Dc,blockSkip:gc,br:sc,code:oc,del:Fs,delLDelim:Fs,delRDelim:Fs,emStrongLDelim:vc,emStrongRDelimAst:xc,emStrongRDelimUnd:Cc,escape:ac,link:jc,nolink:Nc,punctuation:fc,reflink:Mc,reflinkSearch:Pc,tag:kc,text:cc,url:Fs},Lc={...Ic,link:Z(/^!?\[(label)\]\((.*?)\)/).replace(`label`,Ac).getRegex(),reflink:Z(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace(`label`,Ac).getRegex()},Rc={...Ic,emStrongRDelimAst:Sc,emStrongLDelim:yc,delLDelim:wc,delRDelim:Tc,url:Z(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace(`protocol`,Fc).replace(`email`,/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:Z(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace(`protocol`,Fc).getRegex()},zc={...Rc,br:Z(sc).replace(`{2,}`,`*`).getRegex(),text:Z(Rc.text).replace(`\\b_`,`\\b_| {2,}\\n`).replace(/\{2,\}/g,`*`).getRegex()},Bc={normal:tc,gfm:rc,pedantic:ic},Vc={normal:Ic,gfm:Rc,breaks:zc,pedantic:Lc},Hc={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},Uc=e=>Hc[e];function Wc(e,t){if(t){if(Q.escapeTest.test(e))return e.replace(Q.escapeReplace,Uc)}else if(Q.escapeTestNoEncode.test(e))return e.replace(Q.escapeReplaceNoEncode,Uc);return e}function Gc(e){try{e=encodeURI(e).replace(Q.percentDecode,`%`)}catch{return null}return e}function Kc(e,t){let n=e.replace(Q.findPipe,(e,t,n)=>{let r=!1,i=t;for(;--i>=0&&n[i]===`\\`;)r=!r;return r?`|`:` |`}).split(Q.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push(``);for(;r<n.length;r++)n[r]=n[r].trim().replace(Q.slashPipe,`|`);return n}function qc(e,t,n){let r=e.length;if(r===0)return``;let i=0;for(;i<r;){let a=e.charAt(r-i-1);if(a===t&&!n)i++;else if(a!==t&&n)i++;else break}return e.slice(0,r-i)}function Jc(e){let t=e.split(`
`),n=t.length-1;for(;n>=0&&Q.blankLine.test(t[n]);)n--;return t.length-n<=2?e:t.slice(0,n+1).join(`
`)}function Yc(e,t){if(e.indexOf(t[1])===-1)return-1;let n=0;for(let r=0;r<e.length;r++)if(e[r]===`\\`)r++;else if(e[r]===t[0])n++;else if(e[r]===t[1]&&(n--,n<0))return r;return n>0?-2:-1}function Xc(e,t=0){let n=t,r=``;for(let t of e)if(t===`	`){let e=4-n%4;r+=` `.repeat(e),n+=e}else r+=t,n++;return r}function Zc(e,t,n,r,i){let a=t.href,o=t.title||null,s=e[1].replace(i.other.outputLinkReplace,`$1`);r.state.inLink=!0;let c={type:e[0].charAt(0)===`!`?`image`:`link`,raw:n,href:a,title:o,text:s,tokens:r.inlineTokens(s)};return r.state.inLink=!1,c}function Qc(e,t,n){let r=e.match(n.other.indentCodeCompensation);if(r===null)return t;let i=r[1];return t.split(`
`).map(e=>{let t=e.match(n.other.beginningSpace);if(t===null)return e;let[r]=t;return r.length>=i.length?e.slice(i.length):e}).join(`
`)}var $c=class{options;rules;lexer;constructor(e){this.options=e||Ns}space(e){let t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:`space`,raw:t[0]}}code(e){let t=this.rules.block.code.exec(e);if(t){let e=this.options.pedantic?t[0]:Jc(t[0]);return{type:`code`,raw:e,codeBlockStyle:`indented`,text:e.replace(this.rules.other.codeRemoveIndent,``)}}}fences(e){let t=this.rules.block.fences.exec(e);if(t){let e=t[0],n=Qc(e,t[3]||``,this.rules);return{type:`code`,raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,`$1`):t[2],text:n}}}heading(e){let t=this.rules.block.heading.exec(e);if(t){let e=t[2].trim();if(this.rules.other.endingHash.test(e)){let t=qc(e,`#`);(this.options.pedantic||!t||this.rules.other.endingSpaceChar.test(t))&&(e=t.trim())}return{type:`heading`,raw:qc(t[0],`
`),depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(e){let t=this.rules.block.hr.exec(e);if(t)return{type:`hr`,raw:qc(t[0],`
...
`+l}u=!l.trim(),r+=p+`
`,e=e.substring(p.length+1),c=m.slice(d)}}i.loose||(o?i.loose=!0:this.rules.other.doubleBlankLine.test(r)&&(o=!0)),i.items.push({type:`list_item`,raw:r,task:!!this.options.gfm&&this.rules.other.listIsTask.test(s),loose:!1,text:s,tokens:[]}),i.raw+=r}let s=i.items.at(-1);if(s)s.raw=s.raw.trimEnd(),s.text=s.text.trimEnd();else return;i.raw=i.raw.trimEnd();for(let e of i.items){this.lexer.state.top=!1,e.tokens=this.lexer.blockTokens(e.text,[]);let t=e.tokens[0];if(e.task&&(t?.type===`text`||t?.type===`paragraph`)){e.text=e.text.replace(this.rules.other.listReplaceTask,``),t.raw=t.raw.replace(this.rules.other.listReplaceTask,``),t.text=t.text.replace(this.rules.other.listReplaceTask,``);for(let e=this.lexer.inlineQueue.length-1;e>=0;e--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[e].src)){this.lexer.inlineQueue[e].src=this.lexer.inlineQueue[e].src.replace(this.rules.other.listReplaceTask,``);break}let n=this.rules.other.listTaskCheckbox.exec(e.raw);if(n){let t={type:`checkbox`,raw:n[0]+` `,checked:n[0]!==`[ ]`};e.checked=t.checked,i.loose?e.tokens[0]&&[`paragraph`,`text`].includes(e.tokens[0].type)&&`tokens`in e.tokens[0]&&e.tokens[0].tokens?(e.tokens[0].raw=t.raw+e.tokens[0].raw,e.tokens[0].text=t.raw+e.tokens[0].text,e.tokens[0].tokens.unshift(t)):e.tokens.unshift({type:`paragraph`,raw:t.raw,text:t.raw,tokens:[t]}):e.tokens.unshift(t)}}else e.task&&=!1;if(!i.loose){let t=e.tokens.filter(e=>e.type===`space`);i.loose=t.length>0&&t.some(e=>this.rules.other.anyLine.test(e.raw))}}if(i.loose)for(let e of i.items){e.loose=!0;for(let t of e.tokens)t.type===`text`&&(t.type=`paragraph`)}return i}}html(e){let t=this.rules.block.html.exec(e);if(t){let e=Jc(t[0]);return{type:`html`,block:!0,raw:e,pre:t[1]===`pre`||t[1]===`script`||t[1]===`style`,text:e}}}def(e){let t=this.rules.block.def.exec(e);if(t){let e=t[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal,` `),n=t[2]?t[2].replace(this.rules.other.hrefBrackets,`$1`).replace(this.rules.inline.anyPunctuation,`$1`):``,r=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline.anyPunctuation,`$1`):t[3];return{type:`def`,tag:e,raw:qc(t[0],`
`),href:n,title:r}}}table(e){let t=this.rules.block.table.exec(e);if(!t||!this.rules.other.tableDelimiter.test(t[2]))return;let n=Kc(t[1]),r=t[2].replace(this.rules.other.tableAlignChars,``).split(`|`),i=t[3]?.trim()?t[3].replace(this.rules.other.tableRowBlankLine,``).split(`
`):[],a={type:`table`,raw:qc(t[0],`
`),header:[],align:[],rows:[]};if(n.length===r.length){for(let e of r)this.rules.other.tableAlignRight.test(e)?a.align.push(`right`):this.rules.other.tableAlignCenter.test(e)?a.align.push(`center`):this.rules.other.tableAlignLeft.test(e)?a.align.push(`left`):a.align.push(null);for(let e=0;e<n.length;e++)a.header.push({text:n[e],tokens:this.lexer.inline(n[e]),header:!0,align:a.align[e]});for(let e of i)a.rows.push(Kc(e,a.header.length).map((e,t)=>({text:e,tokens:this.lexer.inline(e),header:!1,align:a.align[t]})));return a}}lheading(e){let t=this.rules.block.lheading.exec(e);if(t){let e=t[1].trim();return{type:`heading`,raw:qc(t[0],`
`),depth:t[2].charAt(0)===`=`?1:2,text:e,tokens:this.lexer.inline(e)}}}paragraph(e){let t=this.rules.block.paragraph.exec(e);if(t){let e=t[1].charAt(t[1].length-1)===`
`?t[1].slice(0,-1):t[1];return{type:`paragraph`,raw:t[0],text:e,tokens:this.lexer.inline(e)}}}text(e){let t=this.rules.block.text.exec(e);if(t)return{type:`text`,raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(e){let t=this.rules.inline.escape.exec(e);if(t)return{type:`escape`,raw:t[0],text:t[1]}}tag(e){let t=this.rules.inline.tag.exec(e);if(t)return!this.lexer.state.inLink&&this.rules.other.startATag.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&this.rules.other.endATag.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&this.rules.other.startPreScriptTag.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&this.rules.other.endPreScriptTag.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:`html`,raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:t[0]}}link(e){let t=this.rules.inline.link.exec(e);if(t){let e=t[2].trim();if(!this.options.pedantic&&this.rules.other.startAngleBracket.test(e)){if(!this.rules.other.endAngleBracket.test(e))return;let t=qc(e.slice(0,-1),`\\`);if((e.length-t.length)%2==0)return}else{let e=Yc(t[2],`()`);if(e===-2)return;if(e>-1){let n=(t[0].indexOf(`!`)===0?5:4)+t[1].length+e;t[2]=t[2].substring(0,e),t[0]=t[0].substring(0,n).trim(),t[3]=``}}let n=t[2],r=``;if(this.options.pedantic){let e=this.rules.other.pedanticHrefTitle.exec(n);e&&(n=e[1],r=e[3])}else r=t[3]?t[3].slice(1,-1):``;return n=n.trim(),this.rules.other.startAngleBracket.test(n)&&(n=this.options.pedantic&&!this.rules.other.endAngleBracket.test(e)?n.slice(1):n.slice(1,-1)),Zc(t,{href:n&&n.replace(this.rules.inline.anyPunctuation,`$1`),title:r&&r.replace(this.rules.inline.anyPunctuation,`$1`)},t[0],this.lexer,this.rules)}}reflink(e,t){let n;if((n=this.rules.inline.reflink.exec(e))||(n=this.rules.inline.nolink.exec(e))){let e=t[(n[2]||n[1]).replace(this.rules.other.multipleSpaceGlobal,` `).toLowerCase()];if(!e){let e=n[0].charAt(0);return{type:`text`,raw:e,text:e}}return Zc(n,e,n[0],this.lexer,this.rules)}}emStrong(e,t,n=``){let r=this.rules.inline.emStrongLDelim.exec(e);if(!(!r||!r[1]&&!r[2]&&!r[3]&&!r[4]||r[4]&&n.match(this.rules.other.unicodeAlphaNumeric))&&(!(r[1]||r[3])||!n||this.rules.inline.punctuation.exec(n))){let n=[...r[0]].length-1,i,a,o=n,s=0,c=r[0][0]===`*`?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(c.lastIndex=0,t=t.slice(-1*e.length+n);(r=c.exec(t))!==null;){if(i=r[1]||r[2]||r[3]||r[4]||r[5]||r[6],!i)continue;if(a=[...i].length,r[3]||r[4]){o+=a;continue}else if((r[5]||r[6])&&n%3&&!((n+a)%3)){s+=a;continue}if(o-=a,o>0)continue;a=Math.min(a,a+o+s);let t=[...r[0]][0].length,c=e.slice(0,n+r.index+t+a);if(Math.min(n,a)%2){let e=c.slice(1,-1);return{type:`em`,raw:c,text:e,tokens:this.lexer.inlineTokens(e)}}let l=c.slice(2,-2);return{type:`strong`,raw:c,text:l,tokens:this.lexer.inlineTokens(l)}}}}codespan(e){let t=this.rules.inline.code.exec(e);if(t){let e=t[2].replace(this.rules.other.newLineCharGlobal,` `),n=this.rules.other.nonSpaceChar.test(e),r=this.rules.other.startingSpaceChar.test(e)&&this.rules.other.endingSpaceChar.test(e);return n&&r&&(e=e.substring(1,e.length-1)),{type:`codespan`,raw:t[0],text:e}}}br(e){let t=this.rules.inline.br.exec(e);if(t)return{type:`br`,raw:t[0]}}del(e,t,n=``){let r=this.rules.inline.delLDelim.exec(e);if(r&&(!r[1]||!n||this.rules.inline.punctuation.exec(n))){let n=[...r[0]].length-1,i,a,o=n,s=this.rules.inline.delRDelim;for(s.lastIndex=0,t=t.slice(-1*e.length+n);(r=s.exec(t))!==null;){if(i=r[1]||r[2]||r[3]||r[4]||r[5]||r[6],!i||(a=[...i].length,a!==n))continue;if(r[3]||r[4]){o+=a;continue}if(o-=a,o>0)continue;a=Math.min(a,a+o);let t=[...r[0]][0].length,s=e.slice(0,n+r.index+t+a),c=s.slice(n,-n);return{type:`del`,raw:s,text:c,tokens:this.lexer.inlineTokens(c)}}}}autolink(e){let t=this.rules.inline.autolink.exec(e);if(t){let e,n;return t[2]===`@`?(e=t[1],n=`mailto:`+e):(e=t[1],n=e),{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}url(e){let t;if(t=this.rules.inline.url.exec(e)){let e,n;if(t[2]===`@`)e=t[0],n=`mailto:`+e;else{let r;do r=t[0],t[0]=this.rules.inline._backpedal.exec(t[0])?.[0]??``;while(r!==t[0]);e=t[0],n=t[1]===`www.`?`http://`+t[0]:t[0]}return{type:`link`,raw:t[0],text:e,href:n,tokens:[{type:`text`,raw:e,text:e}]}}}inlineText(e){let t=this.rules.inline.text.exec(e);if(t){let e=this.lexer.state.inRawBlock;return{type:`text`,raw:t[0],text:t[0],escaped:e}}}},el=class e{tokens;options;state;inlineQueue;tokenizer;constructor(e){this.tokens=[],this.tokens.links=Object.create(null),this.options=e||Ns,this.options.tokenizer=this.options.tokenizer||new $c,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};let t={other:Q,block:Bc.normal,inline:Vc.normal};this.options.pedantic?(t.block=Bc.pedantic,t.inline=Vc.pedantic):this.options.gfm&&(t.block=Bc.gfm,this.options.breaks?t.inline=Vc.breaks:t.inline=Vc.gfm),this.tokenizer.rules=t}static get rules(){return{block:Bc,inline:Vc}}static lex(t,n){return new e(n).lex(t)}static lexInline(t,n){return new e(n).inlineTokens(t)}lex(e){e=e.replace(Q.carriageReturn,`
...
`}strong({tokens:e}){return`<strong>${this.parser.parseInline(e)}</strong>`}em({tokens:e}){return`<em>${this.parser.parseInline(e)}</em>`}codespan({text:e}){return`<code>${Wc(e,!0)}</code>`}br(e){return`<br>`}del({tokens:e}){return`<del>${this.parser.parseInline(e)}</del>`}link({href:e,title:t,tokens:n}){let r=this.parser.parseInline(n),i=Gc(e);if(i===null)return r;e=i;let a=`<a href="`+e+`"`;return t&&(a+=` title="`+Wc(t)+`"`),a+=`>`+r+`</a>`,a}image({href:e,title:t,text:n,tokens:r}){r&&(n=this.parser.parseInline(r,this.parser.textRenderer));let i=Gc(e);if(i===null)return Wc(n);e=i;let a=`<img src="${e}" alt="${Wc(n)}"`;return t&&(a+=` title="${Wc(t)}"`),a+=`>`,a}text(e){return`tokens`in e&&e.tokens?this.parser.parseInline(e.tokens):`escaped`in e&&e.escaped?e.text:Wc(e.text)}},nl=class{strong({text:e}){return e}em({text:e}){return e}codespan({text:e}){return e}del({text:e}){return e}html({text:e}){return e}text({text:e}){return e}link({text:e}){return``+e}image({text:e}){return``+e}br(){return``}checkbox({raw:e}){return e}},rl=class e{options;renderer;textRenderer;constructor(e){this.options=e||Ns,this.options.renderer=this.options.renderer||new tl,this.renderer=this.options.renderer,this.renderer.options=this.options,this.renderer.parser=this,this.textRenderer=new nl}static parse(t,n){return new e(n).parse(t)}static parseInline(t,n){return new e(n).parseInline(t)}parse(e){this.renderer.parser=this;let t=``;for(let n=0;n<e.length;n++){let r=e[n];if(this.options.extensions?.renderers?.[r.type]){let e=r,n=this.options.extensions.renderers[e.type].call({parser:this},e);if(n!==!1||![`space`,`hr`,`heading`,`code`,`table`,`blockquote`,`list`,`html`,`def`,`paragraph`,`text`].includes(e.type)){t+=n||``;continue}}let i=r;switch(i.type){case`space`:t+=this.renderer.space(i);break;case`hr`:t+=this.renderer.hr(i);break;case`heading`:t+=this.renderer.heading(i);break;case`code`:t+=this.renderer.code(i);break;case`table`:t+=this.renderer.table(i);break;case`blockquote`:t+=this.renderer.blockquote(i);break;case`list`:t+=this.renderer.list(i);break;case`checkbox`:t+=this.renderer.checkbox(i);break;case`html`:t+=this.renderer.html(i);break;case`def`:t+=this.renderer.def(i);break;case`paragraph`:t+=this.renderer.paragraph(i);break;case`text`:t+=this.renderer.text(i);break;default:{let e=`Token with "`+i.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return t}parseInline(e,t=this.renderer){this.renderer.parser=this;let n=``;for(let r=0;r<e.length;r++){let i=e[r];if(this.options.extensions?.renderers?.[i.type]){let e=this.options.extensions.renderers[i.type].call({parser:this},i);if(e!==!1||![`escape`,`html`,`link`,`image`,`strong`,`em`,`codespan`,`br`,`del`,`text`].includes(i.type)){n+=e||``;continue}}let a=i;switch(a.type){case`escape`:n+=t.text(a);break;case`html`:n+=t.html(a);break;case`link`:n+=t.link(a);break;case`image`:n+=t.image(a);break;case`checkbox`:n+=t.checkbox(a);break;case`strong`:n+=t.strong(a);break;case`em`:n+=t.em(a);break;case`codespan`:n+=t.codespan(a);break;case`br`:n+=t.br(a);break;case`del`:n+=t.del(a);break;case`text`:n+=t.text(a);break;default:{let e=`Token with "`+a.type+`" type was not found.`;if(this.options.silent)return console.error(e),``;throw Error(e)}}}return n}},il=class{options;block;constructor(e){this.options=e||Ns}static passThroughHooks=new Set([`preprocess`,`postprocess`,`processAllTokens`,`emStrongMask`]);static passThroughHooksRespectAsync=new Set([`preprocess`,`postprocess`,`processAllTokens`]);preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}emStrongMask(e){return e}provideLexer(e=this.block){return e?el.lex:el.lexInline}provideParser(e=this.block){return e?rl.parse:rl.parseInline}},al=new class{defaults=Ms();options=this.setOptions;parse=this.parseMarkdown(!0);parseInline=this.parseMarkdown(!1);Parser=rl;Renderer=tl;TextRenderer=nl;Lexer=el;Tokenizer=$c;Hooks=il;constructor(...e){this.use(...e)}walkTokens(e,t){let n=[];for(let r of e)switch(n=n.concat(t.call(this,r)),r.type){case`table`:{let e=r;for(let r of e.header)n=n.concat(this.walkTokens(r.tokens,t));for(let r of e.rows)for(let e of r)n=n.concat(this.walkTokens(e.tokens,t));break}case`list`:{let e=r;n=n.concat(this.walkTokens(e.items,t));break}default:{let e=r;this.defaults.extensions?.childTokens?.[e.type]?this.defaults.extensions.childTokens[e.type].forEach(r=>{let i=e[r].flat(1/0);n=n.concat(this.walkTokens(i,t))}):e.tokens&&(n=n.concat(this.walkTokens(e.tokens,t)))}}return n}use(...e){let t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(e=>{let n={...e};if(n.async=this.defaults.async||n.async||!1,e.extensions&&(e.extensions.forEach(e=>{if(!e.name)throw Error(`extension name required`);if(`renderer`in e){let n=t.renderers[e.name];n?t.renderers[e.name]=function(...t){let r=e.renderer.apply(this,t);return r===!1&&(r=n.apply(this,t)),r}:t.renderers[e.name]=e.renderer}if(`tokenizer`in e){if(!e.level||e.level!==`block`&&e.level!==`inline`)throw Error(`extension level must be 'block' or 'inline'`);let n=t[e.level];n?n.unshift(e.tokenizer):t[e.level]=[e.tokenizer],e.start&&(e.level===`block`?t.startBlock?t.startBlock.push(e.start):t.startBlock=[e.start]:e.level===`inline`&&(t.startInline?t.startInline.push(e.start):t.startInline=[e.start]))}`childTokens`in e&&e.childTokens&&(t.childTokens[e.name]=e.childTokens)}),n.extensions=t),e.renderer){let t=this.defaults.renderer||new tl(this.defaults);for(let n in e.renderer){if(!(n in t))throw Error(`renderer '${n}' does not exist`);if([`options`,`parser`].includes(n))continue;let r=n,i=e.renderer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n||``}}n.renderer=t}if(e.tokenizer){let t=this.defaults.tokenizer||new $c(this.defaults);for(let n in e.tokenizer){if(!(n in t))throw Error(`tokenizer '${n}' does not exist`);if([`options`,`rules`,`lexer`].includes(n))continue;let r=n,i=e.tokenizer[r],a=t[r];t[r]=(...e)=>{let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.tokenizer=t}if(e.hooks){let t=this.defaults.hooks||new il;for(let n in e.hooks){if(!(n in t))throw Error(`hook '${n}' does not exist`);if([`options`,`block`].includes(n))continue;let r=n,i=e.hooks[r],a=t[r];il.passThroughHooks.has(n)?t[r]=e=>{if(this.defaults.async&&il.passThroughHooksRespectAsync.has(n))return(async()=>{let n=await i.call(t,e);return a.call(t,n)})();let r=i.call(t,e);return a.call(t,r)}:t[r]=(...e)=>{if(this.defaults.async)return(async()=>{let n=await i.apply(t,e);return n===!1&&(n=await a.apply(t,e)),n})();let n=i.apply(t,e);return n===!1&&(n=a.apply(t,e)),n}}n.hooks=t}if(e.walkTokens){let t=this.defaults.walkTokens,r=e.walkTokens;n.walkTokens=function(e){let n=[];return n.push(r.call(this,e)),t&&(n=n.concat(t.call(this,e))),n}}this.defaults={...this.defaults,...n}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return el.lex(e,t??this.defaults)}parser(e,t){return rl.parse(e,t??this.defaults)}parseMarkdown(e){return(t,n)=>{let r={...n},i={...this.defaults,...r},a=this.onError(!!i.silent,!!i.async);if(this.defaults.async===!0&&r.async===!1)return a(Error(`marked(): The async option was set to true by an extension. Remove async: false from the parse options object to return a Promise.`));if(typeof t>`u`||t===null)return a(Error(`marked(): input parameter is undefined or null`));if(typeof t!=`string`)return a(Error(`marked(): input parameter is of type `+Object.prototype.toString.call(t)+`, string expected`));if(i.hooks&&(i.hooks.options=i,i.hooks.block=e),i.async)return(async()=>{let n=i.hooks?await i.hooks.preprocess(t):t,r=await(i.hooks?await i.hooks.provideLexer(e):e?el.lex:el.lexInline)(n,i),a=i.hooks?await i.hooks.processAllTokens(r):r;i.walkTokens&&await Promise.all(this.walkTokens(a,i.walkTokens));let o=await(i.hooks?await i.hooks.provideParser(e):e?rl.parse:rl.parseInline)(a,i);return i.hooks?await i.hooks.postprocess(o):o})().catch(a);try{i.hooks&&(t=i.hooks.preprocess(t));let n=(i.hooks?i.hooks.provideLexer(e):e?el.lex:el.lexInline)(t,i);i.hooks&&(n=i.hooks.processAllTokens(n)),i.walkTokens&&this.walkTokens(n,i.walkTokens);let r=(i.hooks?i.hooks.provideParser(e):e?rl.parse:rl.parseInline)(n,i);return i.hooks&&(r=i.hooks.postprocess(r)),r}catch(e){return a(e)}}}onError(e,t){return n=>{if(n.message+=`
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+Wc(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}};function $(e,t){return al.parse(e,t)}$.options=$.setOptions=function(e){return al.setOptions(e),$.defaults=al.defaults,Ps($.defaults),$},$.getDefaults=Ms,$.defaults=Ns,$.use=function(...e){return al.use(...e),$.defaults=al.defaults,Ps($.defaults),$},$.walkTokens=function(e,t){return al.walkTokens(e,t)},$.parseInline=al.parseInline,$.Parser=rl,$.parser=rl.parse,$.Renderer=tl,$.TextRenderer=nl,$.Lexer=el,$.lexer=el.lex,$.Tokenizer=$c,$.Hooks=il,$.parse=$,$.options,$.setOptions,$.use,$.walkTokens,$.parseInline,rl.parse,el.lex;var ol=Object.assign({"/src/content/en/about.md":Xi,"/src/content/en/announcement.md":Zi,"/src/content/en/contact.md":Qi,"/src/content/en/hero.md":$i,"/src/content/en/highlights-PartyAndCatering.md":ea,"/src/content/en/highlights-materials.md":ta,"/src/content/en/highlights-partners.md":na,"/src/content/en/highlights-what-we-do.md":ra,"/src/content/en/menu-2026-05-09.md":ia,"/src/content/en/menu-2026-05-10.md":aa,"/src/content/en/menu-2026-05-11.md":oa,"/src/content/en/menu-2026-05-12.md":sa,"/src/content/en/menu-2026-05-13.md":ca,"/src/content/en/menu-2026-05-18.md":la,"/src/content/en/menu-2026-05-19.md":ua,"/src/content/en/menu-2026-05-20.md":da,"/src/content/en/menu-2026-05-21.md":fa,"/src/content/en/menu-2026-05-22.md":pa,"/src/content/en/menu-2026-05-25.md":ma,"/src/content/en/menu-2026-05-26.md":ha,"/src/content/en/menu-2026-05-27.md":ga,"/src/content/en/menu-2026-05-28.md":_a,"/src/content/en/menu-2026-05-29.md":va,"/src/content/en/menu-2026-06-01.md":ya,"/src/content/en/menu-2026-06-02.md":ba,"/src/content/en/menu-2026-06-03.md":xa,"/src/content/en/menu-2026-06-04.md":Sa,"/src/content/en/menu-2026-06-05.md":Ca,"/src/content/en/menu-2026-06-08.md":wa,"/src/content/en/menu-2026-06-09.md":Ta,"/src/content/en/menu-2026-06-10.md":Ea,"/src/content/en/menu-2026-06-11.md":Da,"/src/content/en/menu-2026-06-12.md":Oa,"/src/content/en/menu-2026-06-15.md":ka,"/src/content/en/menu-2026-06-16.md":Aa,"/src/content/en/menu-2026-06-17.md":ja,"/src/content/en/menu-2026-06-18.md":Ma,"/src/content/en/menu-2026-06-19.md":Na,"/src/content/en/menu-2026-06-22.md":Pa,"/src/content/en/menu-2026-06-23.md":Fa,"/src/content/en/menu-2026-06-24.md":Ia,"/src/content/en/menu-2026-06-25.md":La,"/src/content/en/menu-2026-06-26.md":Ra,"/src/content/en/menu-2026-06-29.md":za,"/src/content/en/menu-2026-06-30.md":Ba,"/src/content/en/menu-2026-07-01.md":Va,"/src/content/en/menu-2026-07-02.md":Ha,"/src/content/en/menu-2026-07-03.md":Ua,"/src/content/en/menu-2026-07-06.md":Wa,"/src/content/en/menu-2026-07-07.md":Ga,"/src/content/en/menu-2026-07-08.md":Ka,"/src/content/en/menu-2026-07-09.md":qa,"/src/content/en/menu-2026-07-10.md":Ja,"/src/content/en/menu-2026-07-13.md":Ya,"/src/content/en/menu-2026-07-14.md":Xa,"/src/content/en/menu-2026-07-15.md":Za,"/src/content/en/menu-2026-07-16.md":Qa,"/src/content/en/menu-2026-07-17.md":$a,"/src/content/en/menu-2026-08-17.md":eo,"/src/content/en/menu-2026-08-18.md":to,"/src/content/en/menu-2026-08-19.md":no,"/src/content/en/menu-2026-08-20.md":ro,"/src/content/en/menu-2026-08-21.md":io,"/src/content/en/menu-2026-08-24.md":ao,"/src/content/en/menu-2026-08-25.md":oo,"/src/content/en/menu-2026-08-26.md":so,"/src/content/en/menu-2026-08-27.md":co,"/src/content/en/menu-2026-08-28.md":lo,"/src/content/en/menu-fixed.md":uo,"/src/content/en/menu.md":fo,"/src/content/en/openingHours.md":po,"/src/content/en/ourServices.md":mo,"/src/content/fr/about.md":ho,"/src/content/fr/announcement.md":go,"/src/content/fr/contact.md":_o,"/src/content/fr/hero.md":vo,"/src/content/fr/highlights-PartyAndCatering.md":yo,"/src/content/fr/highlights-materials.md":bo,"/src/content/fr/highlights-partners.md":xo,"/src/content/fr/highlights-what-we-do.md":So,"/src/content/fr/menu-2026-05-09.md":Co,"/src/content/fr/menu-2026-05-10.md":wo,"/src/content/fr/menu-2026-05-11.md":To,"/src/content/fr/menu-2026-05-12.md":Eo,"/src/content/fr/menu-2026-05-13.md":Do,"/src/content/fr/menu-2026-05-18.md":Oo,"/src/content/fr/menu-2026-05-19.md":ko,"/src/content/fr/menu-2026-05-20.md":Ao,"/src/content/fr/menu-2026-05-21.md":jo,"/src/content/fr/menu-2026-05-22.md":Mo,"/src/content/fr/menu-2026-05-25.md":No,"/src/content/fr/menu-2026-05-26.md":Po,"/src/content/fr/menu-2026-05-27.md":Fo,"/src/content/fr/menu-2026-05-28.md":Io,"/src/content/fr/menu-2026-05-29.md":Lo,"/src/content/fr/menu-2026-06-01.md":Ro,"/src/content/fr/menu-2026-06-02.md":zo,"/src/content/fr/menu-2026-06-03.md":Bo,"/src/content/fr/menu-2026-06-04.md":Vo,"/src/content/fr/menu-2026-06-05.md":Ho,"/src/content/fr/menu-2026-06-08.md":Uo,"/src/content/fr/menu-2026-06-09.md":Wo,"/src/content/fr/menu-2026-06-10.md":Go,"/src/content/fr/menu-2026-06-11.md":Ko,"/src/content/fr/menu-2026-06-12.md":qo,"/src/content/fr/menu-2026-06-15.md":Jo,"/src/content/fr/menu-2026-06-16.md":Yo,"/src/content/fr/menu-2026-06-17.md":Xo,"/src/content/fr/menu-2026-06-18.md":Zo,"/src/content/fr/menu-2026-06-19.md":Qo,"/src/content/fr/menu-2026-06-22.md":$o,"/src/content/fr/menu-2026-06-23.md":es,"/src/content/fr/menu-2026-06-24.md":ts,"/src/content/fr/menu-2026-06-25.md":ns,"/src/content/fr/menu-2026-06-26.md":rs,"/src/content/fr/menu-2026-06-29.md":is,"/src/content/fr/menu-2026-06-30.md":as,"/src/content/fr/menu-2026-07-01.md":os,"/src/content/fr/menu-2026-07-02.md":ss,"/src/content/fr/menu-2026-07-03.md":cs,"/src/content/fr/menu-2026-07-06.md":ls,"/src/content/fr/menu-2026-07-07.md":us,"/src/content/fr/menu-2026-07-08.md":ds,"/src/content/fr/menu-2026-07-09.md":fs,"/src/content/fr/menu-2026-07-10.md":ps,"/src/content/fr/menu-2026-07-13.md":ms,"/src/content/fr/menu-2026-07-14.md":hs,"/src/content/fr/menu-2026-07-15.md":gs,"/src/content/fr/menu-2026-07-16.md":_s,"/src/content/fr/menu-2026-07-17.md":vs,"/src/content/fr/menu-2026-08-17.md":ys,"/src/content/fr/menu-2026-08-18.md":bs,"/src/content/fr/menu-2026-08-19.md":xs,"/src/content/fr/menu-2026-08-20.md":Ss,"/src/content/fr/menu-2026-08-21.md":Cs,"/src/content/fr/menu-2026-08-24.md":ws,"/src/content/fr/menu-2026-08-25.md":Ts,"/src/content/fr/menu-2026-08-26.md":Es,"/src/content/fr/menu-2026-08-27.md":Ds,"/src/content/fr/menu-2026-08-28.md":Os,"/src/content/fr/menu-fixed.md":ks,"/src/content/fr/menu.md":As,"/src/content/fr/openingHours.md":js});async function sl(e,t){let n=ol[`/src/content/${e}/${t}.md`];return n?$(n):`<p>Error loading content (404)</p>`}function cl(e,t){let n=`/src/content/${e}/${t}`;return Object.keys(ol).filter(e=>e.startsWith(n)).map(e=>e.replace(n,``).replace(`.md`,``))}var ll=`/assets/cafe-photo-v5lvKbvt.webp`,ul=K(`<div></div>`);function dl(e,t){A(t,!1);let n=()=>ut(Y,`$currentLanguage`,r),[r,i]=dt(),a=F(``);Ii(async()=>{I(a,await sl(n(),`openingHours`))}),Fn(()=>(n(),sl),()=>{n()&&sl(n(),`openingHours`).then(e=>I(a,e))}),In(),Ni();var o=ul();oi(o,()=>W(a),!0),O(o),q(e,o),j(),i()}var fl=K(`<section id="home" class="hero min-h-fit"><div class="hero-content flex-col lg:flex-row-reverse gap-8 px-4 w-full max-w-6xl"><img alt="Cafe background" class="max-w-full md:max-w-lg lg:max-w-xl xl:max-w-2xl rounded-3xl shadow-2xl object-cover transition-transform duration-700 hover:scale-[1.02]"/> <div class="text-left flex-1"><div class="prose prose-lg lg:prose-xl"></div> <!> <!></div></div></section>`);function pl(e,t){A(t,!1);let n=()=>ut(Y,`$currentLanguage`,r),[r,i]=dt(),a=F(``);Ii(async()=>{I(a,await sl(n(),`hero`))}),Fn(()=>(n(),sl),()=>{n()&&sl(n(),`hero`).then(e=>I(a,e))}),In(),Ni();var o=fl(),s=R(o),c=R(s),l=z(c,2),u=R(l);oi(u,()=>W(a),!0),O(u);var d=z(u,2);dl(d,{}),J(z(d,2),e=>{}),O(l),O(s),O(o),B(()=>Ci(c,`src`,ll)),q(e,o),j(),i()}function ml(e){let t=new Intl.DateTimeFormat(`en-US`,{timeZone:`Europe/Zurich`,year:`numeric`,month:`2-digit`,day:`2-digit`}).formatToParts(e),n={};for(let e of t)n[e.type]=e.value;return`${n.year}-${n.month}-${n.day}`}async function hl(){try{let e=(await fetch(window.location.href,{method:`HEAD`,cache:`no-store`})).headers.get(`Date`);if(e)return new Date(e)}catch(e){console.warn(`Failed to fetch server date, falling back to local client time:`,e)}return new Date}var gl=K(`<h2 class="text-4xl md:text-5xl font-bold text-center mb-12"> </h2>`);function _l(e,t){let n=Fi(t,`title`,8,``);var r=gl(),i=R(r,!0);O(r),B(()=>Wr(i,n())),q(e,r)}var vl=K(`<button> </button>`),yl=K(`<div class="flex flex-wrap justify-center gap-2 mb-2"></div>`),bl=K(`<div class="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-base-100/50 backdrop-blur-sm z-10 rounded-2xl"><span class="loading loading-spinner loading-lg text-primary"></span> <p class="text-primary font-medium animate-pulse"> </p></div>`),xl=K(`<div class="alert alert-info shadow-lg border-primary/50 bg-base-100"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="stroke-primary shrink-0 w-6 h-6"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> <span> </span></div>`),Sl=K(`<div class="fixed-menu-container mt-6 pt-1 border-t border-primary/20"></div>`),Cl=K(`<section id="menu" class="py-20 px-4"><div class="max-w-4xl mx-auto"><div class="menu-header"><!> <!></div> <div class="relative min-h-[300px] py-0 px-4"><!> <div><!> <!></div></div></div></section>`);function wl(e,t){A(t,!1);let n=()=>ut(Y,`$currentLanguage`,r),[r,i]=dt(),a=F(``),o=F(``),s=F(!0),c=F([]),l=ml(new Date),u=F(l);function d(e){let[t,n,r]=ml(e).split(`-`).map(Number);return Array.from({length:7},(e,i)=>{let a=new Date(Date.UTC(t,n-1,r+i,12,0,0));return{iso:ml(a),raw:a}})}let f=F(d(new Date));async function p(){let e=await hl();l=ml(e),I(u,l),I(f,d(e))}async function m(e){let t=cl(e,`menu-`);I(c,W(f).filter(e=>t.includes(e.iso))),W(c).length===0&&cl(e,`menu`).includes(``)&&(I(c,[{iso:`default`,raw:new Date}]),I(u,`default`)),!W(c).find(e=>e.iso===W(u))&&W(c).length>0&&I(u,W(c)[0].iso)}async function h(e,t){if(!e)return;I(s,!0);let n=await sl(t,`menu-${e}`);n.includes(`Error loading content (404)`)||n.includes(`<!DOCTYPE html>`)?I(a,`<div class="alert alert-info shadow-lg border-primary/50 bg-base-100">
                 ...
                 </div>`):I(a,n),I(s,!1)}async function g(e){cl(e,`menu-fixed`).includes(``)?I(o,await sl(e,`menu-fixed`)):I(o,``)}function _(e,t){if(ml(e)===l)return X(`menu.today`,t);let n=t===`fr`?`fr-CH`:`en-US`;return new Intl.DateTimeFormat(n,{weekday:`short`,day:`numeric`,month:`short`,timeZone:`Europe/Zurich`}).format(e)}Ii(async()=>{await p(),await m(n()),await g(n())}),Fn(()=>(n(),W(f)),()=>{(n()||W(f))&&(m(n()),g(n()))}),Fn(()=>(W(u),n()),()=>{W(u)&&h(W(u),n())}),In(),Ni();var v=Cl(),y=R(v),b=R(y),x=R(b);{let e=Ht(()=>(wr(X),n(),G(()=>X(`nav.menu`,n()))));_l(x,{get title(){return W(e)}})}var S=z(x,2),ee=e=>{var t=yl();ei(t,5,()=>W(c),Xr,(e,t)=>{var r=vl(),i=R(r,!0);O(r),B(e=>{mi(r,1,`btn btn-sm md:btn-md transition-all duration-300 ${(W(u),W(t),G(()=>W(u)===W(t).iso?`btn-primary shadow-primary scale-105`:`btn-ghost border-primary/50 hover:border-primary`))??``}`),Wr(i,e)},[()=>(W(t),n(),G(()=>_(W(t).raw,n())))]),Mr(`click`,r,()=>I(u,W(t).iso)),q(e,r)}),O(t),q(e,t)};J(S,e=>{W(c),G(()=>W(c).length>0)&&e(ee)}),O(b);var C=z(b,2),te=R(C),ne=e=>{var t=bl(),r=z(R(t),2),i=R(r,!0);O(r),O(t),B(e=>Wr(i,e),[()=>(wr(X),n(),G(()=>X(`menu.loading`,n())))]),q(e,t)};J(te,e=>{W(s)&&e(ne)});var re=z(te,2),ie=R(re),ae=e=>{var t=xl(),r=z(R(t),2),i=R(r,!0);O(r),O(t),B(e=>Wr(i,e),[()=>(wr(X),n(),G(()=>X(`menu.notAvailable`,n())))]),q(e,t)},oe=e=>{var t=Ur();oi(hn(t),()=>W(a)),q(e,t)};J(ie,e=>{W(c),W(s),G(()=>W(c).length===0&&!W(s))?e(ae):e(oe,-1)});var se=z(ie,2),ce=e=>{var t=Sl();oi(t,()=>W(o),!0),O(t),q(e,t)};J(se,e=>{W(o)&&e(ce)}),O(re),O(C),O(y),O(v),B(()=>mi(re,1,`prose prose-lg max-w-none transition-opacity duration-300 ${W(s)?`opacity-20`:`opacity-100`}`)),q(e,v),j(),i()}var Tl=`/assets/dia-chef-pic-D6G6pAyG.webp`,El=K(`<section id="about" class="py-20 px-4"><div class="max-w-4xl mx-auto"><!> <div class="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12"><div class="flex-shrink-0"><img alt="Chef Dia Patel" class="w-full md:w-80 h-auto rounded-xl shadow-lg transition-transform hover:scale-105"/></div> <div class="prose prose-lg"></div></div></div></section>`);function Dl(e,t){A(t,!1);let n=()=>ut(Y,`$currentLanguage`,r),[r,i]=dt(),a=F(``);Ii(async()=>{I(a,await sl(n(),`about`))}),Fn(()=>(n(),sl),()=>{n()&&sl(n(),`about`).then(e=>I(a,e))}),In(),Ni();var o=El(),s=R(o),c=R(s);{let e=Ht(()=>(wr(X),n(),G(()=>X(`nav.about`,n()))));_l(c,{get title(){return W(e)}})}var l=z(c,2),u=R(l),d=R(u);O(u);var f=z(u,2);oi(f,()=>W(a),!0),O(f),O(l),O(s),O(o),B(()=>Ci(d,`src`,Tl)),q(e,o),j(),i()}var Ol=K(`<button> </button>`),kl=K(`<div class="flex flex-wrap justify-center gap-2 mb-12"></div>`),Al=K(`<div class="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-base-100/50 backdrop-blur-sm z-10 rounded-3xl"><span class="loading loading-spinner loading-lg text-primary"></span></div>`),jl=K(`<p class="text-center opacity-50 italic py-12"> </p>`),Ml=K(`<section id="highlights" class="py-20 px-4"><div class="max-w-4xl mx-auto"><!> <!> <div class="relative min-h-[300px] bg-base-300 p-8 rounded-3xl shadow-inner border border-primary/50"><!> <div><!></div></div></div></section>`);function Nl(e,t){A(t,!1);let n=()=>ut(Y,`$currentLanguage`,r),[r,i]=dt(),a=F(!0),o=F(``),s=F([]),c=F(``),l=Object.assign({"/src/content/en/highlights-PartyAndCatering.md":ea,"/src/content/en/highlights-materials.md":ta,"/src/content/en/highlights-partners.md":na,"/src/content/en/highlights-what-we-do.md":ra,"/src/content/fr/highlights-PartyAndCatering.md":yo,"/src/content/fr/highlights-materials.md":bo,"/src/content/fr/highlights-partners.md":xo,"/src/content/fr/highlights-what-we-do.md":So});function u(e){I(a,!0);let t=[],n=`/src/content/${e}/highlights-`;Object.entries(l).forEach(([e,r])=>{if(e.startsWith(n)){let i=e.replace(n,``).replace(`.md`,``);if(!d(r))return;let a=r.match(/<!--\s*tab:\s*(.*?)\s*-->/),o=a?a[1]:i.replace(/-/g,` `);t.push({id:i,label:o,rawContent:r})}}),I(s,t.sort((e,t)=>e.id.localeCompare(t.id))),W(s).length>0?(!W(o)||!W(s).find(e=>e.id===W(o)))&&I(o,W(s)[0].id):I(o,``),f(),I(a,!1)}function d(e){let t=e.match(/<!--\s*show:\s*(true|false)\s*-->/i);return!t||t[1].toLowerCase()!==`false`}function f(){let e=W(s).find(e=>e.id===W(o));e?I(c,$(e.rawContent.replace(/<!--\s*tab:.*?\s*-->/,``))):I(c,``)}Ii(()=>{u(n())}),Fn(()=>n(),()=>{n()&&u(n())}),Fn(()=>W(o),()=>{W(o)&&f()}),In(),Ni();var p=Ml(),m=R(p),h=R(m);{let e=Ht(()=>(wr(X),n(),G(()=>X(`nav.highlights`,n()))));_l(h,{get title(){return W(e)}})}var g=z(h,2),_=e=>{var t=kl();ei(t,5,()=>W(s),Xr,(e,t)=>{var n=Ol(),r=R(n,!0);O(n),B(()=>{mi(n,1,`btn btn-sm md:btn-md transition-all duration-300 ${(W(o),W(t),G(()=>W(o)===W(t).id?`btn-primary shadow-primary scale-105`:`btn-ghost border-primary/50 hover:border-primary`))??``}`),Wr(r,(W(t),G(()=>W(t).label)))}),Mr(`click`,n,()=>I(o,W(t).id)),q(e,n)}),O(t),q(e,t)};J(g,e=>{W(s),G(()=>W(s).length>0)&&e(_)});var v=z(g,2),y=R(v),b=e=>{q(e,Al())};J(y,e=>{W(a)&&e(b)});var x=z(y,2),S=R(x),ee=e=>{var t=Ur();oi(hn(t),()=>W(c)),q(e,t)},C=e=>{var t=jl(),r=R(t);O(t),B(()=>Wr(r,`No highlight files found in src/content/${n()??``}/highlights-*.md`)),q(e,t)};J(S,e=>{W(s),G(()=>W(s).length>0)?e(ee):e(C,-1)}),O(x),O(v),O(m),O(p),B(()=>mi(x,1,`prose prose-lg max-w-none transition-opacity duration-300 ${W(a)?`opacity-20`:`opacity-100`}`)),q(e,p),j(),i()}async function Pl(e){try{return(await fetch(`https://formspree.io/f/YOUR_FORM_ID`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)})).ok}catch(e){return console.error(`Reservation error:`,e),!1}}var Fl=K(`<div class="alert alert-success mb-4"><svg class="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> <span> </span></div>`),Il=K(`<div class="alert alert-error mb-4"><span> </span></div>`),Ll=K(`<option> </option>`),Rl=K(`<span class="loading loading-spinner"></span>`),zl=K(`<section id="reservation" class="py-20 px-4"><div class="max-w-md mx-auto"><!> <!> <!> <form class="space-y-4"><input type="text" class="input input-bordered w-full" required=""/> <input type="email" class="input input-bordered w-full" required=""/> <input type="tel" class="input input-bordered w-full" required=""/> <input type="date" class="input input-bordered w-full" required=""/> <input type="time" class="input input-bordered w-full" required=""/> <select class="select select-bordered w-full"></select> <textarea class="textarea textarea-bordered w-full"></textarea> <button type="submit" class="btn btn-primary w-full"><!> </button></form></div></section>`);function Bl(e,t){A(t,!1);let n=()=>ut(Y,`$currentLanguage`,r),[r,i]=dt(),a=F(``),o=F(``),s=F(``),c=F(``),l=F(``),u=F(`2`),d=F(``),f=F(!1),p=F(!1),m=F(``);async function h(){I(f,!0),I(m,``),I(p,!1),await Pl({name:W(a),email:W(o),phone:W(s),date:W(c),time:W(l),guests:W(u),message:W(d),language:n()})?(I(p,!0),I(a,I(o,I(s,I(c,I(l,I(d,``)))))),I(u,`2`),setTimeout(()=>I(p,!1),5e3)):I(m,`Failed to submit reservation. Please try again.`),I(f,!1)}Ni();var g=zl(),_=R(g),v=R(_);{let e=Ht(()=>X(`reservation.title`,n()));_l(v,{get title(){return W(e)}})}var y=z(v,2),b=e=>{var t=Fl(),r=z(R(t),2),i=R(r,!0);O(r),O(t),B(e=>Wr(i,e),[()=>X(`reservation.success`,n())]),q(e,t)};J(y,e=>{W(p)&&e(b)});var x=z(y,2),S=e=>{var t=Il(),n=R(t),r=R(n,!0);O(n),O(t),B(()=>Wr(r,W(m))),q(e,t)};J(x,e=>{W(m)&&e(S)});var ee=z(x,2),C=R(ee);Si(C);var te=z(C,2);Si(te);var ne=z(te,2);Si(ne);var re=z(ne,2);Si(re);var ie=z(re,2);Si(ie);var ae=z(ie,2);ei(ae,4,()=>Array.from({length:10},(e,t)=>t+1),Xr,(e,t)=>{var r=Ll(),i=R(r);O(r);var a={};B(e=>{Wr(i,`${t??``} ${e??``}`),a!==(a=t)&&(r.value=(r.__value=t)??``)},[()=>X(`reservation.guests`,n())]),q(e,r)}),O(ae);var oe=z(ae,2);bn(oe);var se=z(oe,2),ce=R(se),le=e=>{q(e,Rl())};J(ce,e=>{W(f)&&e(le)});var ue=z(ce);O(se),O(ee),O(_),O(g),B((e,t,n,r,i)=>{Ci(C,`placeholder`,e),Ci(te,`placeholder`,t),Ci(ne,`placeholder`,n),Ci(oe,`placeholder`,r),se.disabled=W(f),Wr(ue,` ${i??``}`)},[()=>X(`reservation.name`,n()),()=>X(`reservation.email`,n()),()=>X(`reservation.phone`,n()),()=>X(`reservation.message`,n()),()=>X(`reservation.submit`,n())]),Di(C,()=>W(a),e=>I(a,e)),Di(te,()=>W(o),e=>I(o,e)),Di(ne,()=>W(s),e=>I(s,e)),Di(re,()=>W(c),e=>I(c,e)),Di(ie,()=>W(l),e=>I(l,e)),_i(ae,()=>W(u),e=>I(u,e)),Di(oe,()=>W(d),e=>I(d,e)),Mr(`submit`,ee,Mi(h)),q(e,g),j(),i()}var Vl=K(`<footer id="contact" class="bg-base-100 py-2 px-4"><div class="py-10 mt-12"><div class="footer footer-center max-w-6xl mx-auto flex flex-col gap-6"><ul class="menu menu-horizontal px-1 font-semibold !m-0"><!></ul> <div class="text-sm opacity-80"> </div></div></div></footer>`);function Hl(e,t){A(t,!1);let n=()=>ut(Y,`$currentLanguage`,r),[r,i]=dt();Ni();var a=Vl(),o=R(a),s=R(o),c=R(s);Ui(R(c),{}),O(c);var l=z(c,2),u=R(l);O(l),O(s),O(o),O(a),B(e=>Wr(u,`© 2026 Dia's Delicacy. ${e??``}`),[()=>X(`footer.rights`,n())]),q(e,a),j(),i()}var Ul=K(`<section id="contact" class="py-20 px-4"><div class="max-w-6xl mx-auto px-4 pb-12"><!> <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mt-12"><div class="flex flex-col gap-y-6 items-center"><div class="prose prose-lg max-w-none bg-base-200 p-8 rounded-2xl shadow-lg border-l-4 border-primary"><!> <!> <hr/> <div class="flex items-center gap-6 mt-4"> <div class="flex gap-4"><a href="https://www.facebook.com/dia.delicacy/" target="_blank" rel="noopener" class="text-primary hover:scale-110 transition-transform"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg></a> <a href="https://www.instagram.com/dia.delicacy/" target="_blank" rel="noopener" class="text-primary hover:scale-110 transition-transform"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="!fill-none"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg></a></div></div></div></div> <div class="flex flex-col h-full rounded-2xl shadow-2xl overflow-hidden w-full aspect-video border-4 border-base-100"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2760.8951221416446!2d6.134216599999999!3d46.2125413!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x478c65c2f3568c37%3A0x48faab26e433a4c0!2sDia%E2%80%99s%20Delicacy!5e0!3m2!1sde!2sde!4v1755112344883!5m2!1sde!2sde" width="100%" height="100%" class="block" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="Google Maps location for Dia's Delicacy"></iframe></div></div></div></section>`);function Wl(e,t){A(t,!1);let n=()=>ut(Y,`$currentLanguage`,r),[r,i]=dt(),a=F(``);Ii(async()=>{I(a,await sl(n(),`contact`))}),Fn(()=>(n(),sl),()=>{n()&&sl(n(),`contact`).then(e=>I(a,e))}),In(),Ni();var o=Ul(),s=R(o),c=R(s);{let e=Ht(()=>(wr(X),n(),G(()=>X(`nav.contact`,n()))));_l(c,{get title(){return W(e)}})}var l=z(c,2),u=R(l),d=R(u),f=R(d);oi(f,()=>W(a));var p=z(f,2);dl(p,{});var m=z(p,4),h=R(m);Ie(),O(m),O(d),O(u),Ie(2),O(l),O(s),O(o),B(e=>Wr(h,`${e??``}: `),[()=>(wr(X),n(),G(()=>X(`contact.follow`,n())))]),q(e,o),j(),i()}var Gl=t({default:()=>Kl}),Kl=`/assets/food_baking_cake1-DsXplmpc.webp`,ql=t({default:()=>Jl}),Jl=`/assets/food_baking_cake2-RBk0Evzd.webp`,Yl=t({default:()=>Xl}),Xl=`/assets/food_baking_pastry1-DRYz8jji.webp`,Zl=t({default:()=>Ql}),Ql=`/assets/food_biryani-BYo6W1CV.webp`,$l=t({default:()=>eu}),eu=`/assets/food_butter_chicken-DPoJOzpD.webp`,tu=t({default:()=>nu}),nu=`/assets/food_catering1-CKWoQZrI.webp`,ru=t({default:()=>iu}),iu=`/assets/food_catering3-CQQ0qqJ4.webp`,au=t({default:()=>ou}),ou=`/assets/food_kheemapav-BdJ4x7mM.webp`,su=t({default:()=>cu}),cu=`/assets/food_naanwich-3YYvtfYD.webp`,lu=t({default:()=>uu}),uu=`/assets/food_rasmalai-jziXLQkh.webp`,du=t({default:()=>fu}),fu=`/assets/food_sabudana_vada-QXZZpi2z.webp`,pu=t({default:()=>mu}),mu=`/assets/food_samosa-ZRmpHNlu.webp`,hu=t({default:()=>gu}),gu=`/assets/food_thali-DXAcNTqN.webp`,_u=t({default:()=>vu}),vu=`/assets/food_thali2-BhVhG-kb.webp`,yu=t({default:()=>bu}),bu=`/assets/food_vadapav-C4wjXWG4.webp`,xu=K(`<div class="flex-none w-[85vw] sm:w-[45vw] lg:w-[30vw] snap-center relative overflow-hidden rounded-2xl shadow-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 group bg-base-100"><img class="w-full h-72 sm:h-80 lg:h-96 object-cover transition-transform duration-700 group-hover:scale-110" loading="lazy"/> <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-end p-6"><p class="text-white font-medium text-lg transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500"> </p></div></div>`),Su=K(`<section id="gallery" class="py-20 px-4 overflow-hidden"><div class="max-w-7xl mx-auto relative"><!> <div class="relative group"><button class="btn btn-circle btn-sm sm:btn-md bg-white/95 hover:bg-white border-none shadow-2xl absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 z-20 hover:scale-110 transition-all text-gray-900" aria-label="Previous"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-8 sm:w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="fill: none;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" stroke="var(--primary-content)" d="M15 19l-7-7 7-7"></path></svg></button> <button class="btn btn-circle btn-sm sm:btn-md bg-white/95 hover:bg-white border-none shadow-2xl absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 z-20 hover:scale-110 transition-all text-gray-900" aria-label="Next"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-8 sm:w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="fill: none;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg></button> <div class="flex overflow-x-auto gap-6 scroll-smooth snap-x snap-mandatory no-scrollbar py-12 px-2 svelte-1ocen1q"></div></div></div></section>`);function Cu(e,t){A(t,!1);let n=()=>ut(Y,`$currentLanguage`,r),[r,i]=dt(),a=Object.entries(Object.assign({"../assets/images/gallery/food_baking_cake1.webp":Gl,"../assets/images/gallery/food_baking_cake2.webp":ql,"../assets/images/gallery/food_baking_pastry1.webp":Yl,"../assets/images/gallery/food_biryani.webp":Zl,"../assets/images/gallery/food_butter_chicken.webp":$l,"../assets/images/gallery/food_catering1.webp":tu,"../assets/images/gallery/food_catering3.webp":ru,"../assets/images/gallery/food_kheemapav.webp":au,"../assets/images/gallery/food_naanwich.webp":su,"../assets/images/gallery/food_rasmalai.webp":lu,"../assets/images/gallery/food_sabudana_vada.webp":du,"../assets/images/gallery/food_samosa.webp":pu,"../assets/images/gallery/food_thali.webp":hu,"../assets/images/gallery/food_thali2.webp":_u,"../assets/images/gallery/food_vadapav.webp":yu})).map(([e,t])=>{let n=e.split(`/`).pop().split(`.`)[0].split(`_`).map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(` `);return{src:t.default,alt:n}}),o=F();function s(e){if(W(o)){let t=W(o).clientWidth*.8;W(o).scrollBy({left:e*t,behavior:`smooth`})}}Ni();var c=Su(),l=R(c),u=R(l);{let e=Ht(()=>X(`nav.gallery`,n()));_l(u,{get title(){return W(e)}})}var d=z(u,2),f=R(d),p=z(f,2),m=z(p,2);ei(m,5,()=>a,Xr,(e,t)=>{var n=xu(),r=R(n),i=z(r,2),a=R(i),o=R(a,!0);O(a),O(i),O(n),B(()=>{Ci(r,`src`,W(t).src),Ci(r,`alt`,W(t).alt),Wr(o,W(t).alt)}),q(e,n)}),O(m),ji(m,e=>I(o,e),()=>W(o)),O(d),O(l),O(c),Mr(`click`,f,()=>s(-1)),Mr(`click`,p,()=>s(1)),q(e,c),j(),i()}var wu=K(`<div class="bg-primary text-white py-3 px-4 relative z-[100] shadow-lg animate-in slide-in-from-top duration-500"><div class="max-w-6xl mx-auto flex items-center justify-between gap-4"><div class="flex-1 flex items-center gap-3"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> <div class="prose prose-sm prose-invert max-w-none banner-content"></div></div> <button class="btn btn-circle btn-ghost btn-xs text-white hover:bg-white/20" aria-label="Close announcement"><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg></button></div></div>`);function Tu(e,t){A(t,!1);let n=()=>ut(Y,`$currentLanguage`,r),[r,i]=dt(),a=F(``),o=F(!1),s=F(!1),c=Object.assign({"/src/content/en/announcement.md":Zi,"/src/content/fr/announcement.md":go});function l(e){let t=e.match(/<!--\s*show:\s*(true|false)\s*-->/i);return!t||t[1].toLowerCase()!==`false`}function u(e){let t=c[`/src/content/${e}/announcement.md`];t?(I(o,l(t)),W(o)&&I(a,$(t.replace(/<!--\s*show:.*?\s*-->/gi,``)))):I(o,!1)}Ii(()=>{u(n())}),Fn(()=>n(),()=>{n()&&u(n())}),In(),Ni();var d=Ur(),f=hn(d),p=e=>{var t=wu(),n=R(t),r=R(n),i=z(R(r),2);oi(i,()=>W(a),!0),O(i),O(r);var o=z(r,2);O(n),O(t),Mr(`click`,o,()=>I(s,!0)),q(e,t)};J(f,e=>{W(o)&&!W(s)&&e(p)}),q(e,d),j(),i()}var Eu=K(`<meta name="viewport" content="width=1920, initial-scale=1.0"/>`),Du=K(`<meta name="viewport" content="width=device-width, initial-scale=1.0"/>`),Ou=K(`<meta name="description" content="A modern Dia's Delicacy website"/> <!>`,1),ku=K(`<div class="standalone-view svelte-1n46o8q"><header class="p-6 flex items-center gap-4 bg-base-100 shadow-sm"><!></header> <!></div>`),Au=K(`<div class="standalone-view svelte-1n46o8q"><header class="p-6 flex items-center gap-4 bg-base-100 shadow-sm"><!></header> <!></div>`),ju=K(`<div class="standalone-view svelte-1n46o8q"><header class="p-6 flex items-center gap-4 bg-base-100 shadow-sm"><!></header> <!></div>`),Mu=K(`<div class="standalone-view tv-view svelte-1n46o8q"><header class="p-6 flex items-center gap-4 bg-base-100 shadow-sm"><!></header> <!></div>`),Nu=K(`<div><!></div>`),Pu=K(`<!> <!> <!> <!>`,1),Fu=K(`<main><!></main>`);function Iu(e,t){A(t,!1);let n=F(),r=F(),i=F(`/`),a=F(!1);Ii(()=>{let e=ml(new Date),t=async()=>{e=ml(await hl())},n=async()=>{ml(await hl())!==e&&window.location.reload()},r=()=>{let e=new URL(window.location.href),t=e.searchParams.get(`lang`);t&&[`en`,`fr`].includes(t)&&Y.set(t);let n=e.searchParams.get(`theme`);n&&(document.documentElement.setAttribute(`data-theme`,n),localStorage.setItem(`theme`,n));let r=e.pathname.replace(/\/$/,``)||`/`;e.hash.startsWith(`#/`)&&(r=e.hash.replace(`#`,``)),I(i,r),I(a,e.searchParams.get(`rt`)===`p`||r===`/tv`),W(a)?document.body.style.overflow=`hidden`:document.body.style.overflow=``};r(),window.addEventListener(`popstate`,r),window.addEventListener(`hashchange`,r),t();let o=setInterval(n,900*1e3),s=()=>{document.visibilityState===`visible`&&n()},c=()=>{n()};return document.addEventListener(`visibilitychange`,s),window.addEventListener(`focus`,c),()=>{window.removeEventListener(`popstate`,r),window.removeEventListener(`hashchange`,r),clearInterval(o),document.removeEventListener(`visibilitychange`,s),window.removeEventListener(`focus`,c)}});let o=[{id:`hero`,component:pl,show:!0},{id:`menu`,component:wl,show:!0},{id:`about`,component:Dl,show:!0},{id:`highlights`,component:Nl,show:!0},{id:`gallery`,component:Cu,show:!0},{id:`contact`,component:Wl,show:!0},{id:`reservation`,component:Bl,show:!1}];Fn(()=>{},()=>{I(n,o.filter(e=>e.show))}),Fn(()=>W(i),()=>{I(r,[`/menu`,`/gallery`,`/highlights`,`/tv`].includes(W(i)))}),In(),Ni();var s=Fu();ci(`1n46o8q`,e=>{var t=Ou(),n=z(hn(t),2),r=e=>{q(e,Eu())},i=e=>{q(e,Du())};J(n,e=>{W(a)?e(r):e(i,-1)}),Pn(()=>{cn.title=`Dia's Delicacy`}),q(e,t)});var c=R(s),l=e=>{var t=ku(),n=R(t);Vi(R(n),{}),O(n),wl(z(n,2),{}),O(t),q(e,t)},u=e=>{var t=Au(),n=R(t);Vi(R(n),{}),O(n),Cu(z(n,2),{}),O(t),q(e,t)},d=e=>{var t=ju(),n=R(t);Vi(R(n),{}),O(n),Nl(z(n,2),{}),O(t),q(e,t)},f=e=>{var t=Mu(),n=R(t);Vi(R(n),{}),O(n),wl(z(n,2),{}),O(t),q(e,t)},p=e=>{var t=Pu(),r=hn(t);Tu(r,{});var i=z(r,2);Yi(i,{});var a=z(i,2);ei(a,1,()=>W(n),Xr,(e,t,n)=>{var r=Nu();mi(r,1,di(n%2==0?`bg-base-200 jqSec`:`bg-base-100 jqSec`)),si(R(r),()=>W(t).component,(e,t)=>{t(e,{})}),O(r),q(e,r)}),Hl(z(a,2),{}),q(e,t)};J(c,e=>{W(i)===`/menu`?e(l):W(i)===`/gallery`?e(u,1):W(i)===`/highlights`?e(d,2):W(i)===`/tv`?e(f,3):e(p,-1)}),O(s),B(()=>mi(s,1,di(W(a)?`rotate-portrait`:``))),q(e,s),j()}Gr(Iu,{target:document.getElementById(`app`)});